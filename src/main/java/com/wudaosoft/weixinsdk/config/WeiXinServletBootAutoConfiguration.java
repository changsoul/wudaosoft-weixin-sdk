 ...
 */
@Configuration
@ServletComponentScan(basePackages = {"com.wudaosoft.weixinsdk.servlet"})
public class WeiXinServletBootAutoConfiguration {
	
	private static final Logger log = LoggerFactory.getLogger(WeiXinServletBootAutoConfiguration.class);
